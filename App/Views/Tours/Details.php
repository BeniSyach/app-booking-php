      ...
      <div class="col-md-10 mx-auto my-3">
         ...
         <div id="gallery-2" class="royalSlider rsUni">
            ...
            foreach ($imges as $img) { ?>
               <a class="rsImg" data-rsBigImg="<?= $img ?>" href="<?= root ?>uploads/<?= $img ?>" data-rsw="400" data-rsh="500">
                  Vincent van Gogh - Still Life: Vase with Twelve Sunflowers
                  <img width="96" height="72" class="rsTmb" src="<?= root ?>uploads/<?= $img ?>" />
               </a>
            <?php } ?>
            ...
            <div class="card p-3 my-2 h-100">
               ...
               <form action="<?= root ?>tours/booking" method="post" autocomplete="off">
                  ...
                  <div class="sidebar-widget-item mt-3">
                     <div class="qty-box mb-2 d-flex align-items-center justify-content-between adult my-2">
                        <label class="font-size-16 my-2">Adults <span><br> Age 18+</span></label>
                        <label class="font-size-16">Price <span> <br><?= currency ?> <?= $adult_price ?? "" ?></span></label>
                     ...
                     <div class="qty-box mb-2 d-flex align-items-center justify-content-between child">
                        <label class="font-size-16">Child <span><br>Age 12-</span></label>
                        <label class="font-size-16"><?= T::price ?> <span><br><?= $_SESSION['phptravels_client_currency'] ?><?= $child_price ?? "" ?></span></label>
                        <div class="d-flex align-items-center">
